...
const SignUp = () => {
    return (
      ...
      <div className="card-body ">
        ...
        <div className="form-control mt-6">
          <button className=" bg-black h-[60px] text-lg text-white">Sign Up</button>
        </div>
          ...
          <div className="flex mx-auto flex-col w-[60%] mt-5  border-opacity-50 ">
           <div className="divider">OR</div>
            ...
            <div className='flex text-center mt-4 gap-4'>
                  <button className='flex grid-cols-1 lg:gap-4 border lg:grid-cols-2 md:border-black md:gap-2 md:grid-cols-2 py-3 px-8'><FaGoogle className='text-xl'></FaGoogle>  <span>Sing Up with Google</span></button>
                  <button className='flex grid-cols-1  md:gap-2 lg:grid-cols-2 lg:gap-4 border border-black md:grid-cols-2  py-3 px-8'> <span className='text-xl'><FaFacebook></FaFacebook></span> Sing Up with Facebook</button>
           </div>
      </div>
    </div>
  </div>
